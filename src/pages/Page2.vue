<template>
  <div>
    ...
    <h1 class="font-biggest semibold mt-big">{{ title || "Test Title" }}</h1>
    <article class="font-small mt-big">
      {{ description || "Test content." }}
      <div>
        <h2 class="font-big semibold mt-normal">Video</h2>
        <Xgplayer class="mt-small" :config="config" @player="playerReady" />
      </div>
      <div>
        <h2 class="font-big semibold mt-normal">Music</h2>
        <audio class="mt-small" controls style="max-height: 100%;max-width: 100%;">
          <source src="/audios/gyz.mp3" type="audio/ogg">
          <source src="/audios/gyz.mp3" type="audio/mpeg">
        </audio>
      </div>
      <div>
        <h3 class="font-big semibold mt-normal">Lonely Warrior</h3>
        <div class="lyric">
          <p>Everything is brave</p>
          <p>The wounds on your forehead, your being different, your mistakes</p>
          <p>You
          ...
          <p>Never giving in to tears</p>
          <p>
          </p>
          <p>I love that you wear tattered clothes</p>
          <p>Yet
