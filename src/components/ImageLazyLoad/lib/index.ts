import { PluginObject, VNode, VNodeDirective, VueConstructor} from 'vue/types'
...
const compute = function(el: ImageElement | any, time: number, preload: number = 0, cb: Function = function(){}) {
